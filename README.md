...
- 📦 **Terraform Modules for Multi-Cloud Environments**  
  Created reusable and secure Terraform modules for AWS and GCP.

- 🐳 **CI/CD Pipeline for Microservices**  
  End-to-end CI/CD using Jenkins, Docker, Kubernetes, and Helm.

See my pinned repositories or visit the [Projects](https://github.com/yourusername?tab=repositories) section.
